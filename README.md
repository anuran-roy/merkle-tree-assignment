...
![](https://miro.medium.com/max/447/1*1e-wyMbvf8-u7Le1LUxTBA.png)

A Merkle Tree is a stateful data structure extensively used in tracking mechanisms (think Git, Blockchain, and other Version Controls).

### Working of a Merkle Tree

![](https://dash-docs.github.io/img/dev/animated-en-merkleblock-creation.gif)

A Merkle Tree is a binary tree used to represent the hashing of blocks recursively from the hashes of the transactions stored inside the block. 

This helps the block verify if any transaction was modified or not, while retaining the efficiency of search and data extraction and correction as in a binary search tree.

### Implementation of a simple Merkle Tree in Java
